...
{
	AC1 = (int16_t)I2C_Read16(I2Cx,BMP180_ADDRESS,BMP180_CAL_AC1_MSB,BMP180_CAL_AC1_LSB);
	AC2 = (int16_t)I2C_Read16(I2Cx,BMP180_ADDRESS,BMP180_CAL_AC2_MSB,BMP180_CAL_AC2_LSB);
	AC3 = (int16_t)I2C_Read16(I2Cx,BMP180_ADDRESS,BMP180_CAL_AC3_MSB,BMP180_CAL_AC3_LSB);
	AC4 = I2C_Read16(I2Cx,BMP180_ADDRESS,BMP180_CAL_AC4_MSB,BMP180_CAL_AC4_LSB);
	AC5 = I2C_Read16(I2Cx,BMP180_ADDRESS,BMP180_CAL_AC5_MSB,BMP180_CAL_AC5_LSB);
	AC6 = I2C_Read16(I2Cx,BMP180_ADDRESS,BMP180_CAL_AC6_MSB,BMP180_CAL_AC6_LSB);
	B1 = (int16_t)I2C_Read16(I2Cx,BMP180_ADDRESS,BMP180_CAL_B1_MSB,BMP180_CAL_B1_LSB);
	B2 = (int16_t)I2C_Read16(I2Cx,BMP180_ADDRESS,BMP180_CAL_B2_MSB,BMP180_CAL_B2_LSB);
	MB = (int16_t)I2C_Read16(I2Cx,BMP180_ADDRESS,BMP180_CAL_MB_MSB,BMP180_CAL_MB_LSB);
	MC = (int16_t)I2C_Read16(I2Cx,BMP180_ADDRESS,BMP180_CAL_MC_MSB,BMP180_CAL_MC_LSB);
	MD = (int16_t)I2C_Read16(I2Cx,BMP180_ADDRESS,BMP180_CAL_MD_MSB,BMP180_CAL_MD_LSB);
}
